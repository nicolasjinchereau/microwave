...
public:
    ...
    /** If true, error can be retrieved using GetErrorMessage and GetErrorLineNumber. */
    bool HasError() const;

    /** Gets the last error message if parsing failed. */
    const std::string& GetErrorMessage() const;

    /** Gets the line number of the last error if parsing failed. */
