...
project "microwave"
    ...
    files {
        ...
        "source/MW/Tools/DynamicLibrary.cpp",
        "source/MW/Tools/DynamicLibrary.ixx",
        "source/MW/Tools/IEditor.ixx",
        "source/MW/Tools/SceneEditor.cpp",
        "source/MW/Tools/SceneEditor.ixx",
        "source/MW/Tools/Tools.ixx",
