...
inline Mat3 Mat3::Scale(float x, float y, float z)
{
    return Mat3(
        x, 0, 0,
        0, y, 0,
...
inline Mat3 Mat3::Translation(float x, float y)
{
    return Mat3(
        1, 0, 0,
        0, 1, 0,
...
inline Mat3 Mat3::Ortho2D(float left, float right, float bottom, float top)
{
    float w = right - left;
    float h = top - bottom;
...
inline Mat3 Mat3::LookRotation(const Vec3& forward, const Vec3& upward)
{
...
inline std::ostream& Mat3::operator<<(std::ostream& os) {
