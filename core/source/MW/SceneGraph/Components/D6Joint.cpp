...
module Microwave.SceneGraph.Components.D6Joint;
...
void D6Joint::FromJson(const json& obj, ObjectLinker* linker)
{
    ...
    ObjectLinker::RestoreLink(linker, self(this), linkBody, obj, "linkBody");
...
void D6Joint::SetLinkBody(const gptr<RigidBody>& body) {
    linkBody = body;
    structureDirty = true;
}
