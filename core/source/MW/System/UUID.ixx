...
void to_string(std::string& str, const UUID& uuid) {
    str = uuid.ToString();
}

void from_string(const std::string& str, UUID& uuid) {
    uuid = UUID::FromString(str);
}

void to_json(json& obj, const UUID& uuid) {
    obj = uuid.ToString();
}

void from_json(const json& obj, UUID& uuid) {
