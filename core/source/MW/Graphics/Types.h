...
inline void to_json(json& obj, const UIVertex& v) {
    obj["pos"] = v.pos;
    obj["uv"] = v.uv;
    obj["col"] = v.col;
}

inline void from_json(const json& obj, UIVertex& v) {
    v.pos = obj.value("pos", v.pos);
    v.uv = obj.value("uv", v.uv);
    v.col = obj.value("col", v.col);
}

inline void to_json(json& obj, const Box& b) {
    obj["left"] = b.left;
    obj["top"] = b.top;
    obj["right"] = b.right;
    obj["bottom"] = b.bottom;
...
inline void from_json(const json& obj, Box& b) {
...
inline void to_json(json& obj, const TextAlign& ta)
{
...
inline void from_json(const json& obj, TextAlign& ta)
{
