...
class WindowSurfaceMacOSOpenGL;
class RenderTextureOpenGL;
class RenderTarget;

class GraphicsContextMacOSOpenGL : public GraphicsContext
{
public:
    sptr<Dispatcher> _dispatcher;
    sptr<WindowSurfaceMacOSOpenGL> _targetSurface;
