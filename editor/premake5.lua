...
project "EditorLib"
    ...
    filter { "action:vs*" }
        ...
        libdirs {
            ...
            "../third_party/graph-collector/lib/$(PlatformName)/$(Configuration)",
    ...
    filter { "action:xcode*" }
        ...
        libdirs {
            ...
            "../third_party/graph-collector/lib/$(PLATFORM_NAME)/$(CONFIGURATION)",
    ...
    filter { "action:android*" }
        ...
        libdirs {
            ...
            "../third_party/graph-collector/lib/$(TARGET_ARCH_ABI)/$(APP_OPTIM)",
